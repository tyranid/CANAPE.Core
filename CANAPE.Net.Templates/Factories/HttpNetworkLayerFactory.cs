...
namespace CANAPE.Net.Templates.Factories
{
    ...
    /// </summary>
    public class HttpNetworkLayerFactory : BaseNetworkLayerFactory
    {
        /// <summary>
        /// Configuration.
        /// </summary>
        public HttpNetworkLayerConfig Config { get; private set; }
        ...
        public HttpNetworkLayerFactory()
        {
            ...
            Config = new HttpNetworkLayerConfig();
        }
        ...
        {
            HttpNetworkLayer layer = new HttpNetworkLayer(Config);
